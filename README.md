...
<p align="center">
  <img src="https://readme-typing-svg.herokuapp.com?color=00C2FF&size=25&center=true&vCenter=true&width=650&lines=QA+Analyst+%7C+Software+Quality;Testes+Manuais+%7C+Automação+%7C+API+Testing;Qualidade+do+Software+do+requisito+à+produção" />
</p>
...
```mermaid
flowchart LR
    A[Requisitos] --> B[Análise de Riscos]
    B --> C[Planejamento de Testes]
    C --> D[Execução]
    D --> E[Automação]
    E --> F[CI/CD]
    F --> G[Release]
...
<p align="center">
  <a href="https://github.com/ldelgado02/inmetrics">
    <img src="https://img.shields.io/badge/🔗_Ver_projeto_no_GitHub-181717?style=for-the-badge&logo=github&logoColor=white"/>
  </a>
</p>
